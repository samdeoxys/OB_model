...
switch lower(ParName)
    ...
    case 'gmodmit' % [Sam] nicotinic modulation on mitral cells
        param.gModmit = str2double(ParValue);
    case 'emodmit' %[Sam] nicotinic modulation on mitral cells
        param.EModmit = str2double(ParValue);
    case 'mitfrac'
        param.MitFrac = str2double(ParValue);
    case 'extparamfrac'
        param.extparamFrac = str2double(ParValue);
